          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div className="netabout">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum incidunt architecto
                  soluta laboriosam, perspiciatis, aspernatur officiis esse.
                </p>
              </div>
              ...
              <div className="navigation">
                ...
                <div className="nav-footer">
                  <ul>
                    ...
                    <li>
                      <a href="properties-right-sidebar.html">Properties Right</a>
                    </li>
                    <li>
                ...
                <div className="twitter-widget contuct">
                  <div className="twitter-area">
                    <div className="single-item">
                      ...
                      <div className="text">
                        <h5>
                          <a href="#">@findhouses</a> all share them with me baby said inspet.
                        </h5>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="newsletters">
                <h3>Newsletters</h3>
                <p>
                  Sign Up for Our Newsletter to get Latest Updates and Offers. Subscribe to receive
                  news in your inbox.
                </p>
              </div>

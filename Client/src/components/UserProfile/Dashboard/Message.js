        ...
        <div className="section-body">
          <div className="messages">
            <div className="message">
              <div className="thumb">
                <img className="img-fluid" src="images/testimonials/ts-1.jpg" alt="" />
              </div>
              <div className="body">
                <h6>Mary Smith</h6>
            ...
            <div className="message">
              <div className="thumb">
                <img className="img-fluid" src="images/testimonials/ts-2.jpg" alt="" />
              </div>
              <div className="body">
                <h6>Karl Tyron</h6>
            ...
            <div className="message">
              <div className="thumb">
                <img className="img-fluid" src="images/testimonials/ts-3.jpg" alt="" />
              </div>
              <div className="body">
                <h6>Lisa Willis</h6>

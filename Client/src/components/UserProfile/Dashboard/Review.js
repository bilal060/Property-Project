        ...
        <div className="section-body">
          <div className="reviews">
            <div className="review">
              <div className="thumb">
                <img className="img-fluid" src="images/testimonials/ts-4.jpg" alt="" />
              </div>
              <div className="body">
                <h5>Family House</h5>
                <h6>Mary Smith</h6>
            ...
            <div className="review">
              <div className="thumb">
                <img className="img-fluid" src="images/testimonials/ts-5.jpg" alt="" />
              </div>
              <div className="body">
                <h5>Bay Apartment</h5>
                <h6>Karl Tyron</h6>
            ...
            <div className="review">
              <div className="thumb">
                <img className="img-fluid" src="images/testimonials/ts-6.jpg" alt="" />
              </div>
              <div className="body">

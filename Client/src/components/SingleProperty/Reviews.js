          ...
          <ul className="col-12 commented pl-0">
            <li className="comm-inf">
              ...
              <div className="col-md-10 comments-info">
                ...
                <div className="rest">
                  <img src="images/single-property/s-1.jpg" className="img-fluid" alt="" />
                </div>
              </div>
            </li>
          </ul>
          ...
          <ul className="col-12 commented mb-0 pl-0">
            <li className="comm-inf">
              ...
              <div className="col-md-10 comments-info">
                ...
                <div className="resti">
                  <div className="rest">
                    <img src="images/single-property/s-2.jpg" className="img-fluid" alt="" />
                  </div>
                  <div className="rest">
                    <img src="images/single-property/s-3.jpg" className="img-fluid" alt="" />
                  </div>
                </div>
              </div>
            </li>

                                    ...
                                    <div class="news-item details no-mb2">
                                        <a href="blog-details.html" class="news-img-link">
                                            <div class="news-item-img">
                                                <img class="img-responsive" src={process.env.PUBLIC_URL + "images/blog/b-1.jpg"} alt="blog image" />
                                            </div>
                                        </a>
                            ...
                            <section class="comments">
                                ...
                                <div class="row mb-4">
                                    <ul class="col-12 commented">
                                        <li class="comm-inf">
                                            <div class="col-md-2">
                                                <img src={process.env.PUBLIC_URL + "images/testimonials/ts-4.jpg"} class="img-fluid" alt="" />
                                            </div>
                                ...
                                <div class="row ml-5">
                                    <ul class="col-12 commented">
                                        <li class="comm-inf">
                                            <div class="col-md-2">
                                                <img src={process.env.PUBLIC_URL + "images/testimonials/ts-5.jpg"} class="img-fluid" alt="" />
                                            </div>
                                            <div class="col-md-10 comments-info">
                                ...
                                <div class="row my-4">
                                    <ul class="col-12 commented">
                                        <li class="comm-inf">
                                            <div class="col-md-2">
                                                <img src={process.env.PUBLIC_URL + "images/testimonials/ts-6.jpg"} class="img-fluid" alt="" />
                                            </div>

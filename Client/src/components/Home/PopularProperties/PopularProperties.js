      ...
      <section className="featured portfolio rec-pro disc">
        <div className="container-fluid">
          ...
          <div className="portfolio col-xl-12">
            <div className="slick-lancers d-flex">
              <div className="agents-grid"  data-aos-delay={150}>
              ...
              <div className="agents-grid"  data-aos-delay={250}>
              ...
              <div className="agents-grid"  data-aos-delay={350}>
              ...
              <div className="agents-grid"  data-aos-delay={450}>
                <div className="landscapes">
